...
$HiddenImports = @(
    ...
    'dead_signal_blueprint_module_audit', 'dead_signal_common_data_registry_audit', 'dead_signal_data_proxy_architecture',
    'dead_signal_datamgr_map_audit', 'dead_signal_fixed_skill_text_audit', 'dead_signal_buff_skill_text_audit',
    ...
    'dead_signal_analytics', 'dead_signal_evidence_graph', 'dead_signal_trace_workspace', 'dead_signal_workflow_lab',
